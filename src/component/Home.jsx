...
function Home() {
  ...
  return (
    <div className="bg-gray-800 min-h-screen pt-4 ">
        <nav className="felx justify-center space-x-4 p-4 bg-emerald-700 text-white rounded-full 
        ...
        <div id="home" className="flex justify-center items-center mt-36 space-x-4 relative -top-20 bg-[url('data:image/svg+xml;base64,'+bgimage)]">
        ...
        <div className="flex justify-center items-center  space-x-4">
          {/* Left Box */}
          <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg w-1/2 h-56">
            <div className="text-center">
          ...
          {/* Right Box */}
          <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg w-2/5 ">
            <div className="text-center">
      ...
      <div className="border-t border-gray-600 my-2 mx-4"></div>
      <div id="services" className="flex flex-col bg-gray-900 h-96">
        <h1 className="flex justify-center items-center mt-3 font-extrabold italic text-5xl bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent mb-4 ">Services</h1>
            ...
            {services.map((service, index) => (
              <div key={index} className="bg-gray-900 text-white p-6 flex-shrink-0 w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="mt-2 w-96 bg-gradient-to-b from-lime-700 via-teal-600 to-blue-300 bg-clip-text text-transparent">{service.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="flex w-full justify-center items-center space-x-4">
          <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg w-1/2 flex flex-col justify-center items-center">
          ...
          <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg w-2/5 mb-7">
